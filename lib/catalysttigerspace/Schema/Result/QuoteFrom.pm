use utf8;
package catalysttigerspace::Schema::Result::QuoteFrom;
...
=head1 TABLE: C<quote_from>

=cut

__PACKAGE__->table("quote_from");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N/2SRZlEDI+QQ3jJ91fvAA
